...
void D3D12HelloTriangle::OnInit()
{
	...
	// Checking the raytracing capabilities of the device
...
D3D12HelloTriangle::CreateBottomLevelAS(std::vector<std::pair<ComPtr<ID3D12Resource>, uint32_t >> vVertexBuffers)
{
	...
	// Its size is also dependant on the scene complexity
...
void D3D12HelloTriangle::CreateTopLevelAS(
	const std::vector<std::pair<ComPtr<ID3D12Resource>,
		DirectX::XMMATRIX>> &instances) // pair of bottom level AS and matrix of the instance
{
